        ...
        <section className={classes.section}>
            <div className={classes.container}>
                <div className={classes.content}>
                    <h3>Baton’s <span className={classes.titleActive}>story</span></h3>
                    <p className={classes.desc}>Baton was born as a good boy one summer. He was growing up in the IT family watching products launching and startups raising. He was with his parents in every ups and downs. They do love him so much. And worked so hard for better life. Many their aims and wishes came true with Baton. So one day when IT agency had started he became a symbol of Batonis.</p>
